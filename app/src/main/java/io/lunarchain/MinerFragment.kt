 ...
 * [MinerFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [MinerFragment.newInstance] factory method to
...
class MinerFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): MinerFragment {
